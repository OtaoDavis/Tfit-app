      ...
      if (!trialUsed) {
        ...
        try {
          ...
          toast({
            ...
            description: "You've used your one free meal scan. Log in to scan more and save your meal history.",
            variant: "default",
          });
        } catch (err) {
      ...
      <CardHeader>
        ...
        <CardDescription>
          {user ? "Upload a picture of your food to get nutritional information." : 
           trialAvailable ? "Try one scan for free! Upload a picture to see its nutritional info." :
